				...
				<div className="container px-4 md:px-6">
					<div className="flex flex-col md:flex-row items-center max-w-6xl mx-auto">
						<div className="flex-1 space-y-6 text-center md:text-left mb-8 md:mb-0 md:pr-10 animate-fade-in">
							...
							<p className="text-xl text-muted-foreground max-w-lg md:max-w-2xl">
								Generate professional LinkedIn content and eye-catching images
								in seconds with PostCraft's AI-powered tools.
							</p>
			...
			<section className="py-16 bg-background">
				<div className="container px-4 md:px-6">
					...
					<div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
						<Card className="border border-border post-card">
						...
						<Card className="border border-border post-card">
							<CardContent className="pt-6">
								...
								<p className="text-muted-foreground">
									Create custom images that complement your posts and increase
									engagement.
								</p>
							</CardContent>
						</Card>
						...
						<Card className="border border-border post-card">
							<CardContent className="pt-6">
								...
								<p className="text-muted-foreground">
									Copy your content or download images with one click for
									immediate use.
								</p>
							</CardContent>
						</Card>
